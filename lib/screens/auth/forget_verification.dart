...
class VerificationForget extends StatefulWidget {
  const VerificationForget({Key? key}) : super(key: key);

  @override
  State<VerificationForget> createState() => _VerificationForgetState();
}

class _VerificationForgetState extends State<VerificationForget> {
  @override
